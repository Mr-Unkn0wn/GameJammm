...
public class DialougeDisplay4 : MonoBehaviour
{
    ...
    public void talking() {
        ...
        switch (primeInt) {
            case 1:
                ...
                Char1speech.text = "Ahhhhhhhhhh! Was? Das ist nicht möglich!";
                Char2name.text = "";
                Char2speech.text = "";
                break;
            case 2:
                ...
                dialogue.SetActive(true);
                Char1Name.text = "Du";
                Char1speech.text = "Bitte lasst mich doch jetzt einfach in Ruhe :(";
                Char2name.text = "";
                Char2speech.text = "";
                break;
            case 3:
                ...
                dialogue.SetActive(true);
                Char1Name.text = "Space-Waifu";
                Char1speech.text = "Oh Nein! Ein letztes Spiel musst du noch gewinnen!";
                Char2name.text = "";
                Char2speech.text = "";
                break;
            case 4:
